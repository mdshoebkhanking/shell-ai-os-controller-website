...
function createTubesScene({
  ...
  const tubeCount = container.clientWidth < 700 ? 3 : 5
  ...
  const keyLight = new THREE.PointLight(palettes[0].tube, 14, 16)
  const rimLight = new THREE.PointLight(palettes[0].glow, 8, 16)
